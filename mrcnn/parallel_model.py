...
class ParallelModel(tf.keras.models.Model):
    ...
    def __init__(self, keras_model, gpu_count):
        ...
        super().__init__(inputs=keras_model.inputs, outputs=self.make_parallel())
    ...
    def make_parallel(self):
        ...
        print(self.inner_model.input_names)
...
if __name__ == "__main__":
    ...
    def build_model(x_train, num_classes):
        ...
        inputs = tf.keras.layers.Input(shape=x_train.shape[1:], name="input_image")
        ...
        return tf.keras.models.Model(inputs, x, name="digit_classifier_model")
